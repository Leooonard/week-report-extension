...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
		_reactDom2.default.render(_react2.default.createElement(_WeekReport.WeekReport, null), document.getElementById("root"));
	};
		...
		_createClass(WeekReport, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_ReportForm.ReportForm, { url: this.state.url })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReportForm = exports.ReportForm = function (_React$Component) {
	    ...
	    function ReportForm() {
	        ...
	        _this.doneChange = _this.doneChange.bind(_this);
	        _this.todoChange = _this.todoChange.bind(_this);
	        _this.shareChange = _this.shareChange.bind(_this);
	    ...
	    _createClass(ReportForm, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "form",
	                { method: "post", action: this.props.url, onSubmit: this.submit },
	                _react2.default.createElement("input", { name: "titleArea", onChange: this.titleChange }),
	                _react2.default.createElement("textarea", { name: "doneArea", onChange: this.doneChange }),
	                _react2.default.createElement("textarea", { name: "todoArea", onChange: this.todoChange }),
	                _react2.default.createElement("textarea", { name: "shareArea", onChange: this.shareChange }),
	                _react2.default.createElement(
	                    "button",
	                    null,
	                    "发表"
